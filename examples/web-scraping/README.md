...
The run prints the TSA QTD factor, then a fixed-width table of quarterly TSA checkpoint volume and operating revenue from Q1 2025 through Q4 of the next calendar year (Southwest's fiscal year is the calendar year). Current-quarter TSA is quarter-to-date.
