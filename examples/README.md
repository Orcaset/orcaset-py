...
- [`citations/`](citations/) — Wraps a SpaceX 10-Q revenue fact as a `Cited` float, grows it at 10% per quarter, and shows the EDGAR accession, frame, and source URL via printouts and `ctx.dependencies(...)`. See [`citations/README.md`](citations/README.md).
