...
- [`web-scraping/`](web-scraping/) — Standalone example project that inlines a TSA checkpoint scrape into a Southwest (LUV) quarterly revenue nowcast. See [`web-scraping/README.md`](web-scraping/README.md).
