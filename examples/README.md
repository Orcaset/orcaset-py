...
- [`citations/`](citations/) — Attaches data source metadata to inline values, using a `float` subclass so sourced leaves carry provenance while derived cells stay ordinary numbers. See [`citations/README.md`](citations/README.md).
